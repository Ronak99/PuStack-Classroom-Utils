...
import com.pustack.live_session_whiteboard.whiteboardSdk.domain.ConvertErrorCode;
...
import com.pustack.live_session_whiteboard.whiteboardSdk.domain.ConverterStatus;
...
public class Converter {
    ...
    private com.pustack.live_session_whiteboard.whiteboardSdk.converter.ConvertType convertType(ConvertType convertType) {
        if (convertType == ConvertType.Static) {
            return com.pustack.live_session_whiteboard.whiteboardSdk.converter.ConvertType.Static;
        } else {
            return com.pustack.live_session_whiteboard.whiteboardSdk.converter.ConvertType.Dynamic;
        }
    }
}
