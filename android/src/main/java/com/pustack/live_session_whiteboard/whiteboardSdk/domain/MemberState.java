...
public class MemberState extends WhiteObject {
     ...
     * @param shapeType 图形工具，默认值为 `Triangle`，详见 {@link ShapeType ShapeType}。
     */
     ...
     * @since 2.12.26
     *
     * @param shapeType 图形工具的类型。详见 {@link ShapeType ShapeType}。
     */
     ...
     * @since 2.12.26
     *
     * @return 图形工具的类型。详见 {@link ShapeType ShapeType}。
     */
