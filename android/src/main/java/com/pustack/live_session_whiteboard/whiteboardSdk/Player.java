...
import com.pustack.live_session_whiteboard.whiteboardSdk.domain.PlayerObserverMode;
...
import com.pustack.live_session_whiteboard.whiteboardSdk.internal.PlayerDelegate;
...
public class Player extends Displayer {
     ...
     * - 回放暂停时，返回值也不会为 0。
     *
     * @param promise Promise<Double> 接口实例，详见 {@link Promise Promise}。你可以通过该接口获取 `getPlaybackSpeed` 的调用结果：
     * - 如果获取成功，将返回白板回放的倍速。
     * - 如果获取失败，将返回错误信息。
     */
     ...
     * 设置白板回放的查看模式。
     *
     * @param mode 白板回放的查看模式，详见 {@link PlayerObserverMode PlayerObserverMode}。
     */
     ...
     *
     * @return 白板回放的阶段，详见 {@link PlayerPhase PlayerPhase}。
     *
     */
     ...
     *
     * @param promise `Promise<PlayerPhase>` 接口实例，详见 {@link Promise Promise}。你可以通过该接口获取 `getPhase` 方法的调用结果：
     *                - 如果方法调用成功，将返回白板回放的阶段。
     *                - 如果方法调用失败，将返回错误信息。
     */
     ...
     *
     * @return 白板回放的状态，详见 {@link PlayerState PlayerState}。
     *
     */
     ...
     * - 如果白板回放处于 `waitingFirstFrame` 阶段，则该方法返回 `null`。
     *
     * @param promise `Promise<PlayerState>` 接口实例，详见 {@link Promise Promise}。你可以通过该接口获取 `getPlayerState` 方法调用的结果：
     *                - 如果方法调用成功，将返回白板回放状态，详见 {@link PlayerState PlayerState}。
     *                - 如果方法调用失败，将返回错误信息。
     */
     ...
     * - 该方法获取的当前播放进度可能不准确。
     *
     * @return 白板回放的时间信息，详见 {@link PlayerTimeInfo PlayerTimeInfo}。
     */
     ...
     *
     * @param promise `Promise<PlayerTimeInfo>` 接口实例，详见 {@link Promise Promise}。你可以通过该接口获取 `getPlayerTimeInfo` 方法的调用结果：
     *                - 如果方法调用成功，将返回白板回放的时间信息，详见 {@link PlayerTimeInfo PlayerTimeInfo}。
     *                - 如果方法调用失败，将返回错误信息。
     */
