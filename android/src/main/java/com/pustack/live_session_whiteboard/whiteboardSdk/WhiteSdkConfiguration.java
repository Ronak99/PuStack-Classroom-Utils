...
import com.pustack.live_session_whiteboard.whiteboardSdk.domain.DeviceType;
import com.pustack.live_session_whiteboard.whiteboardSdk.domain.LoggerOptions;
...
public class WhiteSdkConfiguration extends WhiteObject {
     ...
     * 获取设置的数据中心。
     *
     * @return 数据中心，详见 {@link Region Region}。
     */
    ...
    private void setupNativeTags() {
        ...
        __nativeTags.put("platform", "android API " + VERSION.SDK_INT);
    }
     ...
     * 并在调用 {@link RoomParams#setUserPayload(Object userPayload) setUserPayload}。
     *
